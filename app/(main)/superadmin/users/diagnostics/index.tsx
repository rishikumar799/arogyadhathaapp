...
export default function DiagnosticsPage() {
  ...
  const [activeDiagnostics, setActiveDiagnostics] = useState<any[]>([]);
  const [deletedDiagnostics, setDeletedDiagnostics] = useState<any[]>([]);
 ...
 useEffect(() => {
  ...
  const diagnostics = useMemo(() => {
    ...
    deletedDiagnostics.forEach(d => deletedMap.set(d.id, d));
    ...
    deletedDiagnostics.forEach(d => merged.push(d));
  ...
  }, [activeDiagnostics, deletedDiagnostics, search]);
      ...
      <View style={styles.header}>
        ...
        <View>
          ...
          <ThemedText style={styles.subtitle}>
            Manage and view registered diagnostics
          </ThemedText>
        </View>
              ...
              {!d.deleted && (
                <>
                  <IconBtn
                    ...
                    onPress={() =>
                      router.push(
                        `/superadmin/users/diagnostics/view/${d.id}`
                      )
                    }
                  />
                  <IconBtn
                    ...
                    onPress={() =>
                      router.push(
                        `/superadmin/users/diagnostics/edit/${d.id}`
                      )
                    }
                  />
                  <IconBtn
