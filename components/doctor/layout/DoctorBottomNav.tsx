...
const MAIN_TABS = [
  { icon: "grid-outline", label: "Home", route: "/doctor", exact: true },
  { icon: "calendar-outline", label: "Appts", route: "/doctor/appointments" },
  { icon: "chatbubble-outline", label: "Consults", route: "/doctor/consultations" },
  { icon: "person-outline", label: "Profile", route: "/doctor/profile" },
];

const MORE_MENU = [
  { icon: "people-outline", label: "Patients", route: "/doctor/patients" },
  { icon: "document-text-outline", label: "Prescriptions", route: "/doctor/prescriptions" },
  { icon: "time-outline", label: "Schedule", route: "/doctor/schedule" },
  { icon: "bar-chart-outline", label: "Reports", route: "/doctor/reports" },
  { icon: "settings-outline", label: "Settings", route: "/doctor/settings" },
];
  ...
  return (
    <>
      ...
      <Modal transparent visible={visible} animationType="none">
        ...
        <Animated.View style={[styles.sheet, { transform: [{ translateY }, { scale: sheetScale }] }]}>
      ...
      <View style={styles.wrapper}>
        ...
        {/* ================= FAB ================= */}
        <Animated.View style={[styles.fabWrap, { transform: [{ scale: fabScale }, { rotate }] }]}>
