...
export default function ReceptionistSideNav() {
  ...
  return (
    <Animated.View style={[styles.sidebar, { width: widthAnim }]}>
      ...
      <View style={styles.profileHeader}>
        ...
        {!collapsed && (
          <>
            <ThemedText style={styles.name}>Receptionist</ThemedText>
      ...
      <ScrollView showsVerticalScrollIndicator={false}>
        ...
        <Nav
          ...
          active={pathname.startsWith("/receptionist/patients")}
          collapsed={collapsed}
        />
        ...
        <Nav
          ...
          active={pathname.startsWith("/receptionist/appointments")}
          collapsed={collapsed}
        />
        ...
        <Nav
          ...
          active={pathname.startsWith("/receptionist/check-in")}
          collapsed={collapsed}
        />
        ...
        <Nav
          ...
          href="/receptionist/schedules"
          active={pathname.startsWith("/receptionist/schedules")}
          collapsed={collapsed}
        />
        ...
        <Nav
          ...
          active={pathname.startsWith("/receptionist/billing")}
          collapsed={collapsed}
        />
        ...
        <Nav
          ...
          active={pathname.startsWith("/receptionist/profile")}
          collapsed={collapsed}
        />
        ...
        <Nav
          ...
          active={pathname.startsWith("/receptionist/settings")}
          collapsed={collapsed}
        />
      </ScrollView>
