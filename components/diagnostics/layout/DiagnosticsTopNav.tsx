...
import diagnosticsAvatar from "@/assets/images/man.png";
...
// PROFILE MODAL
import DiagnosticsProfileMenuModal from "@/components/diagnostics/layout/DiagnosticsProfileMenuModal";
...
export default function DiagnosticsTopNav() {
  ...
  const [centerName, setCenterName] = useState("Diagnostics");
  ...
  useEffect(() => {
    (async () => {
      ...
      if (session?.name) setCenterName(session.name);
    })();
  }, []);
        ...
        <View style={styles.container}>
          ...
          <View style={styles.right}>
            <TouchableOpacity onPress={() => setProfileOpen(true)}>
              <Image source={diagnosticsAvatar} style={styles.avatar} />
            </TouchableOpacity>
            ...
            >
              ...
              <View style={styles.drawerHeader}>
                <View style={styles.drawerBrand}>
                  ...
                  <Text style={styles.drawerTitle}>Diagnostics</Text>
                </View>
              ...
              <ScrollView showsVerticalScrollIndicator={false}>
                <NavItem icon="grid-outline" label="Dashboard" active={pathname === "/diagnostics"} onPress={() => go("/diagnostics")} />
                <NavItem icon="list-outline" label="Tests" active={isActive("/diagnostics/tests")} onPress={() => go("/diagnostics/tests")} />
                <NavItem icon="flask-outline" label="Orders" active={isActive("/diagnostics/orders")} onPress={() => go("/diagnostics/orders")} />
                <NavItem icon="document-text-outline" label="Reports" active={isActive("/diagnostics/reports")} onPress={() => go("/diagnostics/reports")} />
                <NavItem icon="bar-chart-outline" label="Analytics" active={isActive("/diagnostics/analytics")} onPress={() => go("/diagnostics/analytics")} />
                <NavItem icon="settings-outline" label="Settings" active={isActive("/diagnostics/settings")} onPress={() => go("/diagnostics/settings")} />
